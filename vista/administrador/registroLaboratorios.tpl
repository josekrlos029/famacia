<script type="text/javascript">
 ...
 $('#filter').keyup(function(){
    ...
    table.find('.recorrer').each(function(index, row) {
     ...
     function consultaPersona(idLaboratorio) {
        var x = $("#mensaje");
        cargando();
        x.html ("<p>Cargando...</p>");
        x.show("speed");
      
        var data = { idLaboratorio: idLaboratorio };

        $.ajax({
            type: "POST",
            url: "/famacia/administrador/consultarLaboratorio",
            data: data
        }).done(function(msg) {
...
function modificarPersona(){
        ...
        var persona ={ idLaboratorio:idLaboratorio,
                    nombre: nombre,
        ...
        $.ajax({
                      type: "POST",
                      url: "/famacia/administrador/modificarLaboratorio",
                      data: persona
                  })
                  .done(function(msg) {
                      ...
                      if (json == "exito") {
                         ...
                         document.getElementById('light').style.display='none';document.getElementById('fade').style.display='none'
                            ...
                            x.html ( "<p>Laboratorio Modificado Correctamente</p>");
                            y.html();
                            exito();
                            ocultar();
                      } else if(json == 23000) {
                            ...
                            limpiarCajas();
                            x.html ( "<p>Error al Modificar Laboratorio</p>");
                            y.html();
                            error();
                            ocultar();
    ...
    $("#form").submit(function() {
        ...
        $.ajax({
            type: "POST",
            url: "/famacia/administrador/registrarLaboratorio",
            data: persona
        })
                .done(function(msg) {
                    ...
                    if (json == "exito") {
                        ...
                        limpiarCajas();
                        x.html("<p>Laboratorio Registrado Correctamente</p>");
                        y.html();
                        exito();
                        ocultar();
...
<div id="cont-form">   
    <form id="form" action="javascript: return false;">
        <table border="0" align="left" width="100%" >
            <tr><td style="text-align: left;"><h2>Registro de Laboratorios</h2></td></tr>
...
<div id="cont-consulta">
    ...
    <table border="0" align="right" width="70%">
        <tr><td style="text-align: center;"><h2>Consulta de Laboratorios</h2></td>
        ...
        <table border="0" align="center" width="100%" id="mitabla" >
            ...
            <tbody id="table">
                ...
                <tr class="recorrer" align="left">
                    <td width="20%"><?php echo $proveedor->getIdLaboratorio(); ?></td>
                    <td width="30%"><?php echo $proveedor->getNombre(); ?></td>
                    <td width="30%" ><?php echo $proveedor->getDescripcion(); ?></td>
                    <td width="5%" style="text-align:right;"><buttom type="submit" class="button small red"  onclick="consultaPersona('<?php echo $proveedor->getIdLaboratorio(); ?>');">...</buttom></td> 
            </tr>
            <?php } ?>
       ...
       <div style=" margin-top: 5%;margin-left: 5%; float:left; width:45%;">
        ...
        <table width="100%">
            <tr>
                ...
                <td>
                    <input class="box-text-disable" value="" id="idLaboratorio" type="text" disabled >
                </td>                          
            </tr>
            <tr>
                <td>
